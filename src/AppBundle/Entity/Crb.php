...
class Crb
{
	...
	/**
	 * @var string|null
	 * @ORM\Column(name="crb_responsable_nom", type="string", length=100, nullable=true)
	 */
	private $crbResponsableNom;
    ...
    public function getCrbResponsableNom(): ?string
    {
        return $this->crbResponsableNom;
    }

    public function setCrbResponsableNom(?string $crbResponsableNom): self
    {
        $this->crbResponsableNom = $crbResponsableNom;
