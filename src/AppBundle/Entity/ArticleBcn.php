...
class ArticleBcn
{
	...
	/**
	 * @var \Etat
	 * @ORM\ManyToOne(targetEntity="Etat",inversedBy="articleBcnRenouvEtatColl")
	 * @ORM\JoinColumns({
	 * @ORM\JoinColumn(name="article_bcn_renouv_etat", referencedColumnName="etat_code")
	 * })
	 */
	private $articleBcnRenouvEtat;
    ...
    public function getArticleBcnRenouvEtat(): ?Etat
    {
        return $this->articleBcnRenouvEtat;
    }

    public function setArticleBcnRenouvEtat(?Etat $articleBcnRenouvEtat): self
    {
        $this->articleBcnRenouvEtat = $articleBcnRenouvEtat;
